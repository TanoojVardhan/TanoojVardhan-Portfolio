  ...
  return (
    <div className="flex flex-col items-center justify-center w-screen h-screen overflow-hidden bg-gradient-to-tl from-black via-zinc-600/20 to-black">
      ...
      <Particles
        ...
        quantity={100}
      />
      <h1 className="z-10 text-4xl text-transparent duration-1000 bg-white cursor-default text-edge-outline !animate-title font-display sm:text-6xl md:text-8xl whitespace-nowrap bg-clip-text py-3.5 px-0.5">
        Tanooj Vardhan
      </h1>
